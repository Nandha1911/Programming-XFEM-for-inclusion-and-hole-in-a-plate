...
def my_funcdetforpartition(i,j,xi1,xi2,c1,c2,N1,N2,N3,N4,element,parlist,part,k):   #Separate function to use determinant for both Stiffness matrix and force vector
